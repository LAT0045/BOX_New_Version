                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () async {
                        ...
                        if (editedData != null) {
                          setState(() {
                            _editedUsername = editedData['name'] ?? _editedUsername;
                            _editedPhoneNumber = editedData['phoneNumber'] ?? _editedPhoneNumber;
                            _editedAddress = editedData['address'] ?? _editedAddress;
                          });
                        }
                      },
                      child: Text(
